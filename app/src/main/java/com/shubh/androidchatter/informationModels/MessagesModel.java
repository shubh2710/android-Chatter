...
public class MessagesModel{
    ...
    public MessagesModel(String messageText, String senderUserName, String reciverUserName, String messageUser, String messageSendTo, Boolean messageSyncState) {
    ...
    public MessagesModel(String messageText, String senderUserName, String reciverUserName, String messageUser, String messageSendTo, Boolean messageSyncState,long messageTime) {
        this.messageText = messageText;
        this.senderUserName = senderUserName;
        this.reciverUserName = reciverUserName;
        this.messageUser = messageUser;
